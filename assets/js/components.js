(function () {
  ...
  var navHTML =
    '<nav id="navbar">' +
      '<div class="nav-inner">' +
        ...
        '<ul class="nav-links">' +
          ...
          '<li><a href="' + (isIndex ? '#referenzen' : 'index.html#referenzen') + '">Projekte</a></li>' +
        '</ul>' +
        '<a href="' + kontaktHref + '" class="nav-cta">Jetzt kontaktieren&nbsp;' +
    ...
    '<div class="mobile-menu" id="mobile-menu">' +
      ...
      '<a href="' + (isIndex ? '#referenzen' : 'index.html#referenzen') + '">Projekte</a>' +
      ...
      '<div class="container">' +
        '<div class="footer-main">' +
          '<div>' +
            ...
            '<a href="' + kontaktHref + '" class="nav-cta" style="align-self:flex-start;">Kontakt aufnehmen&nbsp;' +
              '<svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M9 5l7 7-7 7"/></svg>' +
            '</a>' +
          '</div>' +
          '<div style="display:flex;flex-direction:column;align-items:flex-end;justify-content:flex-end;gap:.35rem;">' +
            ...
            '<a href="' + (isIndex ? '#referenzen' : 'index.html#referenzen') + '" class="footer-nav-link">Projekte <span class="footer-nav-arrow">›</span></a>' +
          '</div>' +
        '</div>' +
  ...
  (function () {
    ...
    function inject(card, fn) {
      ...
      var sq = Array.from({ length: Math.floor(Math.random() * 4) + 6 }, function () {
    ...
    document.querySelectorAll('.contact-form, .contact-box, .profil-card-main, .profil-card-side').forEach(function (card) {
